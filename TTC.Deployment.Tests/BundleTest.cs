...
namespace TTC.Deployment.Tests
{
    ...
    public class BundleTest
    {
        ...
        public void DeploymentManifestAllowsAutoScalingGroups()
        {
            ...
            var bundle = new Bundle("HelloWorld-AutoScaling", dir, "SomeVersion", "SomeBucket", "SomeETag", "SomeStackName");
        ...
        public void MissingDeploymentManifestThrowsUsefulError()
        {
            ...
            Assert.That(() => new Bundle("HelloWorld-NoDeploySpec", dir, "SomeVersion", "SomeBucket", "SomeETag", "SomeStackName"), Throws.InstanceOf<MissingDeploymentManifestException>());
        }
    }
